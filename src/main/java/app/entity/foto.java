...
public class foto implements Serializable {
  ...
  * @generated
  */
  @Column(name = "importa", nullable = true, unique = false, insertable=true, updatable=true)
  
  private byte[] importa;
  ...
  public byte[] getImporta(){
    return this.importa;
  }

  /**
   * Define importa
   * @param importa importa
   * @generated
   */
  public foto setImporta(byte[] importa){
